...
public class FireminderContentProvider extends ContentProvider {

  private static final String TAG = "FireminderContentProvider";
  ...
  public boolean onCreate() {
    sUriMatcher.addURI(AUTHORITY, Table.Alarm.name, Table.Alarm.id);

    FireminderDatabaseHelper ivyHelper = new FireminderDatabaseHelper(getContext());
  ...
  public enum Table {
    Alarm(1, AlarmTable.NAME, new AlarmTable().createTableCommand());
  ...
  public int delete(Uri uri, String selection, String[] selectionArgs) {
    ...
    try {
      ...
      Timber.e(TAG, "delete() Error during delete " + ex);
    }
    notifyChange(uri);
    return count;
  }
  ...
  public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
    ...
    try {
      ...
      Timber.e(TAG, "update() Error during update" + ex);
    }
    notifyChange(uri);
    return count;
  }
  ...
  protected static class FireminderDatabaseHelper extends SQLiteOpenHelper {

    public FireminderDatabaseHelper(Context context) {
